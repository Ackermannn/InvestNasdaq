...
def is_buy_signal(data, day):
    return (data['Close'][day] > data['MA60'][day]) & (data['Close'][day] > data['MA250'][day])


# 判断是否是卖点信号
def is_sell_signal(data, day):
    return data['Close'][day] < data['MA60'][day]
...
def main():
    ...
    # 时间范围
    data = data['2019-10-29':'2024-10-29']
